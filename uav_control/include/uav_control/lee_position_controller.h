...
#ifndef UAV_CONTROL_LEE_POSITION_CONTROLLER_H
#define UAV_CONTROL_LEE_POSITION_CONTROLLER_H
...
class LeePositionController {
 public:
  ...
  void OverallController(Eigen::Vector4d &torque_thrust);
...
#endif // UAV_CONTROL_LEE_POSITION_CONTROLLER_H
